...
import br.com.sandro.mvc.mudi.model.StatusPedido;
...
public class UsuarioController {
	...
	@GetMapping("pedido/{status}") // mapeamento das urls
	public String proStatus(@PathVariable("status") String status, Model model, Principal principal) {		
